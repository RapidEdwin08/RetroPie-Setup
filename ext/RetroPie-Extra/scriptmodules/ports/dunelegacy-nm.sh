...
function sources_dunelegacy-nm() {
    gitPullOrClone
    download "https://raw.githubusercontent.com/RapidEdwin08/RetroPie-Setup/master/ext/RetroPie-Extra/scriptmodules/ports/$md_id/DuneII_64x64.xpm" "$md_build"
}
...
function remove_dunelegacy-nm() {
    if [[ -f "/usr/share/applications/Dune II The New Missions.desktop" ]]; then sudo rm -f "/usr/share/applications/Dune II The New Missions.desktop"; fi
    if [[ -f "$home/Desktop/Dune II The New Missions.desktop" ]]; then rm -f "$home/Desktop/Dune II The New Missions.desktop"; fi
    if [[ -f "$romdir/ports/Dune II The New Missions.sh" ]]; then rm "$romdir/ports/Dune II The New Missions.sh"; fi
}
...
_EOF_
    ...
    cat >"$md_inst/Dune II The New Missions.desktop" << _EOF_
[Desktop Entry]
Name=Dune II The New Missions
GenericName=Dune II The New Missions
Comment=Dune II The New Missions
...
StartupWMClass=Dune II The New Missions
Name[en_US]=Dune II The New Missions
_EOF_
    chmod 755 "$md_inst/Dune II The New Missions.desktop"
    if [[ -d "$home/Desktop" ]]; then cp "$md_inst/Dune II The New Missions.desktop" "$home/Desktop/Dune II The New Missions.desktop"; chown $__user:$__user "$home/Desktop/Dune II The New Missions.desktop"; fi
    mv "$md_inst/Dune II The New Missions.desktop" "/usr/share/applications/Dune II The New Missions.desktop"

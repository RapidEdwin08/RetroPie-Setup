...
function install_bin_aethersx2() {
    ...
    downloadAndExtract "https://raw.githubusercontent.com/RapidEdwin08/RetroPie-Setup-Assets/main/emulators/aethersx2-rp-assets.tar.gz" "$md_build"
    ...
    if isPlatform "rpi"; then
        ...
        sed -i s+'IntegerScaling =.*'+'IntegerScaling = true'+g "PCSX2.ini.aethersx2"
